...
from plaid_skel.models.monitoring_consumer_report_permissible_purpose import MonitoringConsumerReportPermissiblePurpose




class CraMonitoringInsightsGetRequest(BaseModel):
    ...
    consumer_report_permissible_purpose: MonitoringConsumerReportPermissiblePurpose = Field()
...
CraMonitoringInsightsGetRequest.update_forward_refs()
