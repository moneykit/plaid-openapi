...
class LinkTokenCreateRequestIncomeVerificationPayrollIncome(BaseModel):
    ...
    parsing_config: Optional[List[IncomeVerificationDocParsingConfig]] = Field(default=None, description="The types of analysis to enable for document uploads. If none are specified, then docs will undergo OCR parsing only. This field is only relevant to participants in the Document Fraud beta.")
