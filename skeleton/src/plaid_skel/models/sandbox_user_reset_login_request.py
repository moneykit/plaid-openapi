...
class SandboxUserResetLoginRequest(BaseModel):
    ...
    item_ids: Optional[List[str]] = Field(default=None, description="An array of `item_id`s associated with the User to be reset.  If empty or `null`, this field will default to resetting all Items associated with the User.")
...
SandboxUserResetLoginRequest.update_forward_refs()
