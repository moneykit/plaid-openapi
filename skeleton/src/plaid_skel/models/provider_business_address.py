...
class ProviderBusinessAddress(BaseModel):
    ...
    is_primary: bool = Field( description="Whether this is the primary address for the business")

ProviderBusinessAddress.update_forward_refs()
