...
class TransferLedgerWithdrawRequest(BaseModel):
    ...
    ledger_id: Optional[str] = Field(default=None, description="Specify which ledger balance to withdraw from. Customers can find a list of `ledger_id`s in the Accounts page of your Plaid Dashboard. If this field is left blank, this will default to id of the default ledger balance.")
    amount: str = Field( description="A positive amount of how much will be withdrawn from the ledger balance (decimal string with two digits of precision e.g. \"5.50\").")
...
TransferLedgerWithdrawRequest.update_forward_refs()
