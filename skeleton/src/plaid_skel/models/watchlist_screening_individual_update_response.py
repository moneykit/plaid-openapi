...
class WatchlistScreeningIndividualUpdateResponse(BaseModel):
    ...
    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#watchlist_screening_individual_update_response"
            }
        }
...
WatchlistScreeningIndividualUpdateResponse.update_forward_refs()
