...
class CraCheckReportCashflowInsightsGetRequest(BaseModel):
    ...
    options: Optional[CraCheckReportCashflowInsightsGetOptions] = Field(default=None,)

CraCheckReportCashflowInsightsGetRequest.update_forward_refs()
