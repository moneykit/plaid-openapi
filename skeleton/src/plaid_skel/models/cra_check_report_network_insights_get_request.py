...
class CraCheckReportNetworkInsightsGetRequest(BaseModel):
    ...
    options: Optional[CraCheckReportNetworkInsightsGetOptions] = Field(default=None,)
...
CraCheckReportNetworkInsightsGetRequest.update_forward_refs()
