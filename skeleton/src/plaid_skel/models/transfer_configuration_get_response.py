...
class TransferConfigurationGetResponse(BaseModel):
    ...
    max_single_transfer_credit_amount: str = Field( description="The max limit of dollar amount of a single credit transfer (decimal string with two digits of precision e.g. \"10.00\").")
    max_single_transfer_debit_amount: str = Field( description="The max limit of dollar amount of a single debit transfer (decimal string with two digits of precision e.g. \"10.00\").")
    ...
    max_monthly_credit_amount: str = Field( description="The max limit of sum of dollar amount of credit transfers in one calendar month (decimal string with two digits of precision e.g. \"10.00\").")
    max_monthly_debit_amount: str = Field( description="The max limit of sum of dollar amount of debit transfers in one calendar month (decimal string with two digits of precision e.g. \"10.00\").")
