...
class SyncUpdatesAvailableWebhook(BaseModel):
    ...
    initial_update_complete: bool = Field( description="Indicates if initial pull information (most recent 30 days of transaction history) is available.")
    historical_update_complete: bool = Field( description="Indicates if historical pull information (maximum transaction history requested, up to 2 years) is available.")
