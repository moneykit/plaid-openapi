...
from plaid_skel.models.cra_partner_insights_item_account_metadata import CraPartnerInsightsItemAccountMetadata
...
class CraPartnerInsightsItemAccount(BaseModel):
    ...
    metadata: CraPartnerInsightsItemAccountMetadata = Field()
...
CraPartnerInsightsItemAccount.update_forward_refs()
