...
from plaid_skel.models.credit_freddie_mac_party import CreditFreddieMacParty




class CreditFreddieMacParties(BaseModel):
    ...
    party: List[CreditFreddieMacParty] = Field()

CreditFreddieMacParties.update_forward_refs()
