...
class WatchlistScreeningEntityHitListRequest(BaseModel):
    """Request input for listing hits for an entity watchlist screening"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#watchlist_screening_entity_hit_list_request"
            }
        }
...
WatchlistScreeningEntityHitListRequest.update_forward_refs()
