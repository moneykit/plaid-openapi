...
class SandboxPaymentProfileResetLoginRequest(BaseModel):
    """SandboxPaymentProfileResetLoginRequest defines the request schema for `/sandbox/payment_profile/reset_login`"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#sandbox_payment_profile_reset_login_request"
            }
        }
...
SandboxPaymentProfileResetLoginRequest.update_forward_refs()
