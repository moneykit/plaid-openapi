...
class CraCheckReportBaseReportGetRequest(BaseModel):
    ...
    item_ids: Optional[List[str]] = Field(default=None, description="The item IDs to include in the Base Report. If not provided, all items associated with the user will be included.")
...
CraCheckReportBaseReportGetRequest.update_forward_refs()
