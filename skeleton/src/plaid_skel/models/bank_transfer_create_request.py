...
class BankTransferCreateRequest(BaseModel):
    ...
    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#bank_transfer_create_request"
            }
        }
    ...
    account_id: str = Field( description="The Plaid `account_id` for the account that will be debited or credited.")
...
BankTransferCreateRequest.update_forward_refs()
