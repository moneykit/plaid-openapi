...
from plaid_skel.models.identity_verification_document_iso8601_date_of_birth import IdentityVerificationDocumentISO8601DateOfBirth
from plaid_skel.models.identity_verification_document_iso8601_expiration_date import IdentityVerificationDocumentISO8601ExpirationDate
from plaid_skel.models.identity_verification_document_iso8601_issue_date import IdentityVerificationDocumentISO8601IssueDate
...
class PhysicalDocumentExtractedData(BaseModel):
    ...
    expiration_date: IdentityVerificationDocumentISO8601ExpirationDate = Field()
    issue_date: IdentityVerificationDocumentISO8601IssueDate = Field()
    ...
    date_of_birth: IdentityVerificationDocumentISO8601DateOfBirth = Field()
    address: IdentityVerificationDocumentAddressResponse = Field()
