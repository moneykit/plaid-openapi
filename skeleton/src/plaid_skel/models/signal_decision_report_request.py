...
class SignalDecisionReportRequest(BaseModel):
    ...
    submitted_at: Optional[datetime_] = Field(default=None, description="The date the ACH debit was submitted to the bank for processing (in ISO 8601 format: `YYYY-MM-DDTHH:mm:ssZ`). This field should correspond to the attempt initiated after the `/signal/schedule` call.")
