...
class RiskCheckStolenIdentity(BaseModel):
    ...
    score: int = Field( description="A score from 0 to 100 indicating the likelihood that the user is a stolen identity.")
    risk_level: Optional[RiskLevel] = Field(default=None,)

RiskCheckStolenIdentity.update_forward_refs()
