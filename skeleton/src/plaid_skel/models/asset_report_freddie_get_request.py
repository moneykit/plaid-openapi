...
class AssetReportFreddieGetRequest(BaseModel):
    """AssetReportFreddieGetRequest defines the request schema for `credit/asset_report/freddie_mac/get`"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#asset_report_freddie_get_request"
            }
        }
...
AssetReportFreddieGetRequest.update_forward_refs()
