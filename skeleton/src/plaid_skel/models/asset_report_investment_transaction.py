...
class AssetReportInvestmentTransaction(BaseModel):
    ...
    vested_quantity: float = Field( description="The total quantity of vested assets held, as reported by the financial institution. Vested assets are only associated with [equities](https://plaid.com/docs/api/products/investments/#investments-holdings-get-response-securities-type).")
    vested_value: float = Field( description="The value of the vested holdings as reported by the institution.")
...
AssetReportInvestmentTransaction.update_forward_refs()
