...
class SignalEvaluateCoreAttributes(BaseModel):
    ...
    is_account_closed: Optional[bool] = Field(default=None, description="Indicates if the receiver bank account is closed")
    is_account_frozen_or_restricted: Optional[bool] = Field(default=None, description="Indicates if the receiver bank account is either frozen or restricted")
    ...
    distinct_ip_addresses_count_30d: Optional[int] = Field(default=None, description="The number of distinct IP addresses linked to the same bank account during Plaid authentication in the last 30 days (max 100)")
    distinct_ip_addresses_count_90d: Optional[int] = Field(default=None, description="The number of distinct IP addresses linked to the same bank account during Plaid authentication in the last 90 days (max 100)")
    ...
    distinct_ssl_tls_connection_sessions_count_3d: Optional[int] = Field(default=None, description="The number of distinct SSL/TLS connection sessions linked to the same bank account during Plaid authentication in the last 3 days")
    distinct_ssl_tls_connection_sessions_count_7d: Optional[int] = Field(default=None, description="The number of distinct SSL/TLS connection sessions linked to the same bank account during Plaid authentication in the last 7 days")
    distinct_ssl_tls_connection_sessions_count_30d: Optional[int] = Field(default=None, description="The number of distinct SSL/TLS connection sessions linked to the same bank account during Plaid authentication in the last 30 days")
    distinct_ssl_tls_connection_sessions_count_90d: Optional[int] = Field(default=None, description="The number of distinct SSL/TLS connection sessions linked to the same bank account during Plaid authentication in the last 90 days")
    ...
    balance_to_transaction_amount_ratio: Optional[float] = Field(default=None, description="Taking `available_or_current_balance` and dividing it by the transaction amount. Useful to say “10% buffer”, for example. This is a convenience function to build Signal Rules upon.")
