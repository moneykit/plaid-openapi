...
class LinkTokenCreateRequestIncomeVerification(BaseModel):
    ...
    income_verification_id: Optional[str] = Field(default=None, description="The `income_verification_id` of the verification instance, as provided by `/income/verification/create`. Replaced by the user token.")
