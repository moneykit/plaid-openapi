...
from plaid_skel.models.user_based_products import UserBasedProducts




class UserProductsTerminateRequest(BaseModel):
    ...
    products: Optional[List[UserBasedProducts]] = Field(default=None, description="An optional list of user-based products to terminate. If not provided, all user-based products will be terminated.")

UserProductsTerminateRequest.update_forward_refs()
