...
from plaid_skel.models.entity_watchlist_screening_program_name import EntityWatchlistScreeningProgramName
...
class EntityWatchlistProgram(BaseModel):
    ...
    name: EntityWatchlistScreeningProgramName = Field()
