...
class WatchlistScreeningEntityListRequest(BaseModel):
    """Request input for listing entity watchlist screenings"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#watchlist_screening_entity_list_request"
            }
        }
...
WatchlistScreeningEntityListRequest.update_forward_refs()
