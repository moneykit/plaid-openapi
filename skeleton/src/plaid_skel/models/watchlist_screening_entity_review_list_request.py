...
class WatchlistScreeningEntityReviewListRequest(BaseModel):
    """Request input for listing reviews for an entity watchlist screening"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#watchlist_screening_entity_review_list_request"
            }
        }
...
WatchlistScreeningEntityReviewListRequest.update_forward_refs()
