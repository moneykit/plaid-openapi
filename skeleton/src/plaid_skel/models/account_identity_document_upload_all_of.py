...
from plaid_skel.models.identity_document_upload import IdentityDocumentUpload
from plaid_skel.models.owner import Owner




class AccountIdentityDocumentUploadAllOf(BaseModel):
    """"""
    ...
    documents: Optional[List[IdentityDocumentUpload]] = Field(default=None, description="Data about the documents that were uploaded as proof of account ownership.")

AccountIdentityDocumentUploadAllOf.update_forward_refs()
