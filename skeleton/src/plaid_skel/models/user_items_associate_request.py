...
class UserItemsAssociateRequest(BaseModel):
    ...
    item_ids: List[str] = Field( description="An array of `item_id`s to be associated with the `user_id`.")

UserItemsAssociateRequest.update_forward_refs()
