...
from plaid_skel.models.base_report_average_monthly_balances import BaseReportAverageMonthlyBalances




class BaseReportAccountBalances(BaseModel):
    ...
    average_balance: Optional[float] = Field(default=None, description="The average historical balance for the entire report")
    average_monthly_balances: Optional[List[BaseReportAverageMonthlyBalances]] = Field(default=None, description="The average historical balance of each calendar month")
    most_recent_thirty_day_average_balance: Optional[float] = Field(default=None, description="The average historical balance from the most recent 30 days")

BaseReportAccountBalances.update_forward_refs()
