...
class AccountAssets(BaseModel):
    ...
    days_available: float = Field( description="The duration of transaction history available for this Item, typically defined as the time since the date of the earliest transaction in that account.")
    ...
    historical_balances: List[HistoricalBalance] = Field( description="Calculated data about the historical balances on the account.")
