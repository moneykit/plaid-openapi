...
class WatchlistScreeningIndividualReviewListRequest(BaseModel):
    """Request input for listing reviews for an individual watchlist screening"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#watchlist_screening_individual_review_list_request"
            }
        }
...
WatchlistScreeningIndividualReviewListRequest.update_forward_refs()
