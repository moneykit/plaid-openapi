...
from plaid_skel.models.cash_flow_updates_event_webhook_codes import CashFlowUpdatesEventWebhookCodes




class SandboxCraCashflowUpdatesUpdateRequest(BaseModel):
    ...
    webhook_codes: Optional[List[CashFlowUpdatesEventWebhookCodes]] = Field(default=None, description="Webhook codes corresponding to the Cash Flow Updates events to be simulated.")
...
SandboxCraCashflowUpdatesUpdateRequest.update_forward_refs()
