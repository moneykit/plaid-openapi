...
class TransferMetricsGetRequest(BaseModel):
    """Defines the request schema for `/transfer/metrics/get`"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#transfer_metrics_get_request"
            }
        }
...
TransferMetricsGetRequest.update_forward_refs()
