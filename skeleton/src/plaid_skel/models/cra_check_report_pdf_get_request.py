...
from plaid_skel.models.cra_pdf_add_ons import CraPDFAddOns




class CraCheckReportPDFGetRequest(BaseModel):
    ...
    add_ons: Optional[List[CraPDFAddOns]] = Field(default=None, description="Use this field to include other reports in the PDF.")
...
CraCheckReportPDFGetRequest.update_forward_refs()
