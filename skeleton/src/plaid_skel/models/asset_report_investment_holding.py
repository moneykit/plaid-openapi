...
class AssetReportInvestmentHolding(BaseModel):
    ...
    ticker_symbol: Optional[str] = Field(default=None, description="The holding's trading symbol for publicly traded holdings, and otherwise a short identifier if available.")
...
AssetReportInvestmentHolding.update_forward_refs()
