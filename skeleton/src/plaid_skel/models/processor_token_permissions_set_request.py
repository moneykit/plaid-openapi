...
class ProcessorTokenPermissionsSetRequest(BaseModel):
    ...
    products: List[Products] = Field( description="A list of products the processor token should have access to. An empty list will grant access to all products.")

ProcessorTokenPermissionsSetRequest.update_forward_refs()
