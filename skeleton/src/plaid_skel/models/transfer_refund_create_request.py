...
class TransferRefundCreateRequest(BaseModel):
    """Defines the request schema for `/transfer/refund/create`"""

    class Config:
        schema_extra = {
            "externalDocs": {
                "url": "https://plaid.com/docs/api/accounts/#transfer_refund_create_request"
            }
        }
...
TransferRefundCreateRequest.update_forward_refs()
