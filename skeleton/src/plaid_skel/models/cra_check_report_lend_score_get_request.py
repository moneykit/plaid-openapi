...
class CraCheckReportLendScoreGetRequest(BaseModel):
    ...
    options: Optional[CraCheckReportLendScoreGetOptions] = Field(default=None,)

CraCheckReportLendScoreGetRequest.update_forward_refs()
